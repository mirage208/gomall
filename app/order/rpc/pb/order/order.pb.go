...
const file_order_proto_rawDesc = "" +
	...
	"\x03Uid\x18\x02 \x01(\x03H\x00R\x03Uid\x88\x01\x01\x12\x15\n" +
	"\x03Pid\x18\x03 \x01(\x03H\x01R\x03Pid\x88\x01\x01\x12\x1b\n" +
	"\x06Amount\x18\x04 \x01(\x03H\x02R\x06Amount\x88\x01\x01\x12\x1b\n" +
	"\x06Status\x18\x05 \x01(\x03H\x03R\x06Status\x88\x01\x01B\x06\n" +
	"\x04_UidB\x06\n" +
	"\x04_PidB\t\n" +
	"\a_AmountB\t\n" +
	"\a_Status\"\x10\n" +
