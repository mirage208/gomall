...
func (m *defaultCartModel) Insert(ctx context.Context, data *Cart) (sql.Result, error) {
	...
	ret, err := m.conn.ExecCtx(ctx, query, data.DeleteTime, data.DelState, data.UserId, data.ProductId, data.Count, data.Checked)
	return ret, err
}
...
func (m *defaultCartModel) Update(ctx context.Context, data *Cart) error {
	...
	_, err := m.conn.ExecCtx(ctx, query, data.DeleteTime, data.DelState, data.UserId, data.ProductId, data.Count, data.Checked, data.Id)
	return err
}
