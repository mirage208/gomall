...
const (
	...
	Cart_CartProductList_FullMethodName       = "/cart.cart/cartProductList"
	Cart_DeleteProductFromCart_FullMethodName = "/cart.cart/deleteProductFromCart"
	Cart_UpdateProductDetail_FullMethodName   = "/cart.cart/updateProductDetail"
)
...
func (c *cartClient) AddProductToCart(ctx context.Context, in *AddProductToCartReq, opts ...grpc.CallOption) (*AddProductToCartResp, error) {
	...
	err := c.cc.Invoke(ctx, Cart_AddProductToCart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cartClient) CartProductList(ctx context.Context, in *CartProductListReq, opts ...grpc.CallOption) (*CartProductListResp, error) {
	...
	err := c.cc.Invoke(ctx, Cart_CartProductList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cartClient) DeleteProductFromCart(ctx context.Context, in *DeleteProductFromCartReq, opts ...grpc.CallOption) (*DeleteProductFromCartResp, error) {
	...
	err := c.cc.Invoke(ctx, Cart_DeleteProductFromCart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cartClient) UpdateProductDetail(ctx context.Context, in *UpdateProductDetailReq, opts ...grpc.CallOption) (*UpdateProductDetailResp, error) {
	...
	err := c.cc.Invoke(ctx, Cart_UpdateProductDetail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
